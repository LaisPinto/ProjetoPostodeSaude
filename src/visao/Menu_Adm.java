...
public class Menu_Adm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jmPessoaa = new javax.swing.JMenuItem();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jMenu1.setText("Acessos");

        jmPessoa.setText("Nova Pessoa");
        ...
        jmPessoaa.setText("Pessoa");
        jmPessoaa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jmPessoaaActionPerformed(evt);
            }
        });
        jMenu2.add(jmPessoaa);
    ...
    private void jmPessoaaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmPessoaaActionPerformed
        abrirTabPessoa();
    }//GEN-LAST:event_jmPessoaaActionPerformed

   private void abrirCadPessoa(){
        TelaCadPessoa tcp = new TelaCadPessoa();
        tcp.setVisible(true);
    }//fecha método
   
    private void abrirTabPessoa(){
        TelaTabPessoa ttp = new TelaTabPessoa();
        ttp.setVisible(true);
    }//fecha método
    ...
    private javax.swing.JMenuItem jmPessoaa;
